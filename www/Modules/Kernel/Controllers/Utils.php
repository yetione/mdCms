...
class Utils extends Controller {
    ...
    public function generateUrl(array $data){
        ...
        if (!$currentUser->hasFlag('a')){
            $v = $this->module->view('Error');
            $v->render(['message'=>'Access Denied', 'code'=>404]);
            return;
        }
        $str = $this->getInput()->get('data', '', TYPE_RAW);
        $str = $this->toAscii($this->r2l($str));
