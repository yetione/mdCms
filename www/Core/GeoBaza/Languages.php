...
class Languages {
    ...
    static public function list_languages() {
     ...
     */
    static public function get_language($id) {
        $lang = self::$languages[$id];
        if (empty($lang)) {
            throw new GeobazaException(sprintf('Language with ISO ID %s does not exists!', $id));
        }
