...
class Types {
    ...
    public static function isBooleanType($mappingType){
        return in_array($mappingType, array( self::BOOLEAN, self::BOOLEAN_EMU ));
    }
    ...
    public static function isLobType($mappingType){
        return in_array($mappingType, array( self::VARBINARY, self::LONGVARBINARY, self::BLOB, self::OBJECT ));
    }
