        ...
        <link rel="icon" type="image/png" href="icons/favicon/android-chrome-192x192.png" sizes="192x192">
        ...
        <link rel="mask-icon" href="icons/favicon/safari-pinned-tab.svg" color="#65a759">
        ...
        <meta name="theme-color" content="#65a759">
        
        <link rel="stylesheet" href="lib/normalize.css">
        <link rel="stylesheet/less" type="text/css" href="styles/styles.less">
        <script src="lib/less.min.js"></script>
        <script src="https://use.fontawesome.com/66801ec087.js"></script>
        <link rel="stylesheet" href="lib/custom-content-scrolling/jquery.mCustomScrollbar.min.css">
