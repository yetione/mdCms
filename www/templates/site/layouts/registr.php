...
<body ng-app="SektaFoodApp" ng-controller="RegistrationPageController as mainCtrl">
...
<form name="RegistrationForm" ng-submit="mainCtrl.doRegistration()" ng-show="!mainCtrl.currentUser.Id">
    <section class="customerdetails" style="text-align: center;">
        ...
        <p>
            <input type="password" placeholder="Пароль" ng-model="mainCtrl.userData.Password">
        </p>
        <p>
            <input type="password" placeholder="Подтверждение пароля" ng-model="mainCtrl.userData.PasswordConfirm">
        </p>
