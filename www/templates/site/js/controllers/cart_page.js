var CartPageController = function($scope, CartService, EntityFactory, $idialog, UsersService){
    var self = this;
...
siteApp.controller('CartPageController', ['$scope', 'CartService', 'EntityFactory', '$idialog', 'UsersService',  CartPageController]);